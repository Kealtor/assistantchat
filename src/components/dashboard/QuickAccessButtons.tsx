...
export const QuickAccessButtons = ({
  ...
  return (
    <div className="flex flex-col gap-4 touch-auto relative z-10">
      ...
      <div className="grid grid-cols-3 2xl:grid-cols-3 gap-3 relative z-10 justify-items-center">
        {allowedWorkflows.map((workflow) => (
          <Button
            ...
            size="lg"
            className={`h-auto min-h-12 w-full flex flex-row items-center justify-center gap-2 py-2 px-3 transition-all touch-manipulation relative z-10 ${
